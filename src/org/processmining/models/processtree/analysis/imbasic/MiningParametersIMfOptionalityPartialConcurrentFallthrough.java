...
public class MiningParametersIMfOptionalityPartialConcurrentFallthrough extends MiningParameters {
	/*
	 * No other parameter, except mentioned in this file, has influence on mined model
	 */
	
	public MiningParametersIMfOptionalityPartialConcurrentFallthrough() {
