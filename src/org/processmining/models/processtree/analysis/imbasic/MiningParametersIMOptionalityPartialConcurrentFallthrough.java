...
public class MiningParametersIMOptionalityPartialConcurrentFallthrough extends MiningParameters {
	
	/*
	 * No other parameter, except mentioned in this file, has influence on the mined model
	 */
	
	public MiningParametersIMOptionalityPartialConcurrentFallthrough() {
