package org.processmining.models.processtree.analysis.imabasic;

import java.util.ArrayList;
import java.util.Arrays;

import org.processmining.models.processtree.analysis.imbasic.FallThroughIMOptionality;
import org.processmining.models.processtree.analysis.imbasic.FallThroughIMOptionalityPartialConcurrent;
import org.processmining.models.processtree.analysis.imbasic.FallThroughIMTrueBasic;
...
public class MiningParametersIMfaOptionalityPartialConcurrentFallthrough extends MiningParameters {
	
	public MiningParametersIMfaOptionalityPartialConcurrentFallthrough() {
		...
		setFallThroughs(new ArrayList<FallThrough>(Arrays.asList(
				new FallThroughIMOptionalityPartialConcurrent()
				)));
